...
if (['runOfflineM05D', 'FakeProvider', 'validateOfflineReceipts', 'offline_fake_provider', 'createCanaryPlan', 'runCanaryPreflight', 'BudgetLedger', 'prepareIsolationRoot', 'adversarial_preflight'].some((symbol) => bundled.includes(symbol))) throw new Error('pack:check: evaluation-only M0.5D/M0.5E symbols leaked into production bundle')
