...
if (['runOfflineM05D', 'FakeProvider', 'validateOfflineReceipts', 'offline_fake_provider'].some((symbol) => bundled.includes(symbol))) throw new Error('pack:check: M0.5D evaluation symbols leaked into production bundle')
