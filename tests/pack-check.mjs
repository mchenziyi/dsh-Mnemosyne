...
export const forbiddenExportSymbols = [
  ...
  'computePlanSha256',
  'computeReportSha256',
  'executeCanaryPreflight',
  'CanaryPlan',
  'CanaryReport',
  'verifyCanaryArtifact',
  'VerifiedCanaryArtifact',
  'REQUIRED_CANARY_TARBALL_FILES',
  'countLayersInDump',
  ...
  'writeRedactedCanaryReport',
  'readRedactedCanaryReport',
  'executeDryRun',
  'executePrepare',
  'executeCanary',
]
...
export const forbiddenSeamSymbols = [
  ...
  'createCanaryPlan',
  'runCanaryPreflight',
  'canary-audit-sidecar',
  'canary-resume-headless-driver',
  'BudgetLedger',
