...
const TARGET_DSH_VERSION = '0.1.5-rc.2'
...
describe('DSH baseline upgrade compatibility suite', () => {
  it('binds compatibility metadata to the audited upstream DSH release', () => {
    ...
    expect(AUDIT_COMMIT).toBe('a30530342297e6006623a775166fee1d14fd413a')
  })
  ...
  it('scans the full lockfile and accepts only the audited rc.2 graph', () => {
