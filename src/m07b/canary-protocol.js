...
export function validateRealCanaryPlan(plan) {
  ...
  if (plan.package_version !== '0.0.0-dev' && plan.package_version !== '0.1.0' && plan.package_version !== '0.2.0') throw new Error('invalid_plan')
...
export function validateRedactedCanaryReport(report) {
  ...
  if (report.package_version !== '0.0.0-dev' && report.package_version !== '0.1.0' && report.package_version !== '0.2.0') throw new Error('invalid_report')
