...
export function validateRealCanaryPlan(plan) {
  ...
  if (plan.package_version !== '0.0.0-dev' && plan.package_version !== '0.1.0' && plan.package_version !== '0.2.0' && plan.package_version !== '0.2.1' && plan.package_version !== '0.2.2' && plan.package_version !== '0.2.3' && plan.package_version !== '0.2.4' && plan.package_version !== '0.2.5' && plan.package_version !== '0.2.6' && plan.package_version !== '0.2.7' && plan.package_version !== '0.2.8' && plan.package_version !== '0.2.9') throw new Error('invalid_plan')
...
export function validateRedactedCanaryReport(report) {
  ...
  if (report.package_version !== '0.0.0-dev' && report.package_version !== '0.1.0' && report.package_version !== '0.2.0' && report.package_version !== '0.2.1' && report.package_version !== '0.2.2' && report.package_version !== '0.2.3' && report.package_version !== '0.2.4' && report.package_version !== '0.2.5' && report.package_version !== '0.2.6' && report.package_version !== '0.2.7' && report.package_version !== '0.2.8' && report.package_version !== '0.2.9') throw new Error('invalid_report')
