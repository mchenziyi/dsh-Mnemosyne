...
export interface OfficialReferenceAudit {
  ...
  source_ref: 'npm:@deepseek-ai/dsh-llm-deepseek@0.1.5-rc.2'
}

export interface ProviderCompatibilityAudit {
  schema_version: 1
  audited_at: string
  project_dsh_version: '0.1.5-rc.2'
...
const TARGET_VERSION = '0.1.5-rc.2' as const
...
const EXPECTED_SOURCE_REF = 'npm:@deepseek-ai/dsh-llm-deepseek@0.1.5-rc.2' as const
