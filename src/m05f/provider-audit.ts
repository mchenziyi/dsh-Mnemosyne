...
export interface OfficialReferenceAudit {
  ...
  package_version: '0.1.2-alpha.4'
  source_ref: 'npm:@deepseek-ai/dsh-llm-deepseek@0.1.2-alpha.4'
}

export interface ProviderCompatibilityAudit {
  schema_version: 1
  audited_at: string
  project_dsh_version: '0.1.2-alpha.4'
...
const EXPECTED_SOURCE_REF = 'npm:@deepseek-ai/dsh-llm-deepseek@0.1.2-alpha.4' as const
